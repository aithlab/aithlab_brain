...
from utils_gs import get_df_from_url, authorize_with_credentials, open_gs_by_url, save_df_to_gd, get_session_id
...
if query:
    ...
    _df_qna.loc[len(_df_qna)] = [date, _session_id, query, response]
